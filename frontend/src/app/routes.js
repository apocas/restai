...
const ProjectsBuilder = Loadable(lazy(() => import("app/views/projects/Builder")));
...
const TeamWallet = Loadable(lazy(() => import("app/views/teams/TeamWallet")));
