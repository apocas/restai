from langchain.llms import GPT4All, LlamaCpp, OpenAI, VertexAI
...
LLMS = {
    ...
    "google_vertexai_bison": (VertexAI, {"model_name": "chat-bison@002", "max_output_tokens":1000, "temperature":0.1}, "chatml", "public", "Google Vertex AI"),
