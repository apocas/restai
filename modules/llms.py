...
LLMS = {
    ...
    "mistral7b_gptq": (Ollama, {"model": "mistral", "temperature": 0.0001}, "chatml", "private", "https://huggingface.co/TheBloke/Mistral-7B-OpenOrca-GPTQ", "qa", "node1"),

    "llama13b_chat_gptq": (Ollama, {"model": "llama2:13b", "temperature": 0.0001}, "llama", "private", "https://huggingface.co/TheBloke/Llama-2-13B-chat-GPTQ", "qa", "node1"),

    "llama7b_chat_gptq": (Ollama, {"model": "llama2:7b", "temperature": 0.0001}, "llama", "private", "https://huggingface.co/TheBloke/Llama-2-7B-Chat-GPTQ", "qa", "node1"),

    "llava_1.5_13b": (Ollama, {"model": "llava", "temperature": 0.0001}, "llava", "private", "https://huggingface.co/llava-hf/llava-1.5-13b-hf", "vision", "node1"),

    "bakllava_v1": (Ollama, {"model": "bakllava", "temperature": 0.0001}, "llava", "private", "https://huggingface.co/llava-hf/bakLlava-v1-hf", "vision", "node1"),

    "mixtral8x7b_instruct_gptq": (Ollama, {"model": "mixtral", "temperature": 0.6}, "mistral", "private", "https://huggingface.co/TheBloke/Mixtral-8x7B-Instruct-v0.1-GPTQ", "qa", "node2"),

    "llama2_70b_chat_gptq": (Ollama, {"model": "llama2:70b", "temperature": 0.0001}, "llama", "private", "https://huggingface.co/TheBloke/Llama-2-70B-Chat-GPTQ", "qa", "node2"),
