...
def test_send_invite_to_team_member():
...
def test_send_invite_to_outsider():
...
def test_send_invite_nonexistent_user():
...
def test_duplicate_invite_not_created():
...
def test_invite_shows_in_invitations():
...
def test_invitation_count_includes_projects():
...
def test_accept_project_invite():
...
def test_decline_project_invite():
...
def test_non_member_cannot_send_invite():
